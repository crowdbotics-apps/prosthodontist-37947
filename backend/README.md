...
## Project Structure
    ...
    ├── prosthodontist_37947  # Django project configurations
...
1. Clone this repo and `cd prosthodontist_37947`
...
2. Clone this repo and `cd prosthodontist_37947`
